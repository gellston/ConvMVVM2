...
namespace ConvMVVM2.WPF.ViewModels
{
    public class MouseViewModel
    {
        ...
        public event Action<Point> LeftUpEvent = null;
        ...
        public event Action<Point> RightUpEvent = null;
        ...
        public event Action<Point> MiddleUpEvent = null;
        ...
        public event Action<Point> PreviewLeftUpEvent = null;
        ...
        public event Action<Point> PreviewRightUpEvent = null;
        ...
        public event Action<Point> PreviewMiddleUpEvent = null;
        ...
        public void RaisePreviewLeftUp(Point pt) => this.PreviewLeftUpEvent?.Invoke(pt);
        ...
        public void RaisePreviewRightUp(Point pt) => this.PreviewRightUpEvent?.Invoke(pt);
        ...
        public void RaisePreviewMiddleUp(Point pt) => this.PreviewMiddleUpEvent?.Invoke(pt);
        ...
        public void RaiseLeftUp(Point pt) => this.LeftUpEvent?.Invoke(pt);
        ...
        public void RaiseRightUp(Point pt) => this.RightUpEvent?.Invoke(pt);
        ...
        public void RaiseMiddleUp(Point pt) => this.MiddleUpEvent?.Invoke(pt);
